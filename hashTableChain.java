...
//----------------------------------------------------------------------------------------
// Hash Table with chain of Nodes
//----------------------------------------------------------------------------------------

public class hashTableChain<K,V> implements Dictionary<K,V> {
	...
	public hashTableChain (int setCapacity) {
	...
	public void put (K key, V data) throws DuplicatedKeyException{	// inserts new record with key & data or ERROR if dictionary already contains a record with the key
		...
		if (list[index] != null) { // a key exist in this index
			...
			System.out.println("Collision when adding "+ key+". Client was added to chain at point " + index);
			throw new DuplicatedKeyException ("Error");
		} else {
			list[index] = node; // add node to index
			System.out.println(key+" ("+data+") was put into the Hash Table at point "+index);
		}
		count++;
	}
...
//			
	...
	public static void main (String[] args) {
		...
		hashTableChain<String, String> test1 = new hashTableChain<String, String>(3);
		try {test1.put("Tay", "Client ID: 97378");} catch (DuplicatedKeyException e) {}
		...
		hashTableChain<String, String> test2 = new hashTableChain<String, String>();
